...
if __name__ == '__main__':
    ...
    #     extend = aron_helper.aronson(letter, n, forward=True, inp=inp, forward_referring=False)
    #     aron_helper.print_sequence(letter, extend)
    #
    ...
    print("found sequences have been verified for both sets")
